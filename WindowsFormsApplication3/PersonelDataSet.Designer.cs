...
namespace WindowsFormsApplication3 {
    ...
    public partial class PersonelDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonelDataTable : global::System.Data.TypedTableBase<PersonelRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonelRow AddPersonelRow(int p_id, string p_Adi, string p_TcKimlikno, string p_Tell, string p_Tell2, string p_Email, string p_Cinsiyet, string p_Pozisyon, string p_Departman) {
            ...
            private void InitClass() {
                ...
                this.columnp_Tell.MaxLength = 11;
                this.columnp_Tell2.MaxLength = 11;
...
namespace WindowsFormsApplication3.PersonelDataSetTableAdapters {
    ...
    public partial class PersonelTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Personel] ([p_id], [p_Adi], [p_TcKimlikno], [p_Tell], [p_Tell2], [p_Email], [p_Cinsiyet], [p_Pozisyon], [p_Departman]) VALUES (@p_id, @p_Adi, @p_TcKimlikno, @p_Tell, @p_Tell2, @p_Email, @p_Cinsiyet, @p_Pozisyon, @p_Departman);
SELECT p_id, p_Adi, p_TcKimlikno, p_Tell, p_Tell2, p_Email, p_Cinsiyet, p_Pozisyon, p_Departman FROM Personel WHERE (p_id = @p_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Personel] SET [p_id] = @p_id, [p_Adi] = @p_Adi, [p_TcKimlikno] = @p_TcKimlikno, [p_Tell] = @p_Tell, [p_Tell2] = @p_Tell2, [p_Email] = @p_Email, [p_Cinsiyet] = @p_Cinsiyet, [p_Pozisyon] = @p_Pozisyon, [p_Departman] = @p_Departman WHERE (([p_id] = @Original_p_id) AND ([p_Adi] = @Original_p_Adi) AND ((@IsNull_p_TcKimlikno = 1 AND [p_TcKimlikno] IS NULL) OR ([p_TcKimlikno] = @Original_p_TcKimlikno)) AND ((@IsNull_p_Tell = 1 AND [p_Tell] IS NULL) OR ([p_Tell] = @Original_p_Tell)) AND ((@IsNull_p_Tell2 = 1 AND [p_Tell2] IS NULL) OR ([p_Tell2] = @Original_p_Tell2)) AND ((@IsNull_p_Email = 1 AND [p_Email] IS NULL) OR ([p_Email] = @Original_p_Email)) AND ((@IsNull_p_Cinsiyet = 1 AND [p_Cinsiyet] IS NULL) OR ([p_Cinsiyet] = @Original_p_Cinsiyet)) AND ([p_Pozisyon] = @Original_p_Pozisyon) AND ((@IsNull_p_Departman = 1 AND [p_Departman] IS NULL) OR ([p_Departman] = @Original_p_Departman)));
SELECT p_id, p_Adi, p_TcKimlikno, p_Tell, p_Tell2, p_Email, p_Cinsiyet, p_Pozisyon, p_Departman FROM Personel WHERE (p_id = @p_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication3.Properties.Settings.Default.PersonelConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT p_id, p_Adi, p_TcKimlikno, p_Tell, p_Tell2, p_Email, p_Cinsiyet, p_Pozisyo" +
                "n, p_Departman FROM dbo.Personel";
        ...
        public virtual int Delete(int Original_p_id, string Original_p_Adi, string Original_p_TcKimlikno, string Original_p_Tell, string Original_p_Tell2, string Original_p_Email, string Original_p_Cinsiyet, string Original_p_Pozisyon, string Original_p_Departman) {
        ...
        public virtual int Insert(int p_id, string p_Adi, string p_TcKimlikno, string p_Tell, string p_Tell2, string p_Email, string p_Cinsiyet, string p_Pozisyon, string p_Departman) {
        ...
        public virtual int Update(
            ...
            if ((Original_p_Adi == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_p_Adi));
            }
            if ((Original_p_TcKimlikno == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_p_TcKimlikno));
            }
            if ((Original_p_Tell == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_p_Tell));
            }
            if ((Original_p_Tell2 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_p_Tell2));
            }
            if ((Original_p_Email == null)) {
            ...
            if ((Original_p_Cinsiyet == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_p_Cinsiyet));
            }
            if ((Original_p_Pozisyon == null)) {
                throw new global::System.ArgumentNullException("Original_p_Pozisyon");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(Original_p_Pozisyon));
            }
            if ((Original_p_Departman == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((string)(Original_p_Departman));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_p_Pozisyon, 
                    string Original_p_Departman) {
            return this.Update(Original_p_id, p_Adi, p_TcKimlikno, p_Tell, p_Tell2, p_Email, p_Cinsiyet, p_Pozisyon, p_Departman, Original_p_id, Original_p_Adi, Original_p_TcKimlikno, Original_p_Tell, Original_p_Tell2, Original_p_Email, Original_p_Cinsiyet, Original_p_Pozisyon, Original_p_Departman);
        }
    }
